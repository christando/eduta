...
<body>
    <div class="container-fluid d-flex justify-content-center align-items-center border vh-100">
        <div class="card w-25 ">
            <div class="card-header bg-primary d-flex justify-content-center text-light"><strong>FORM REGISTER</strong></div>
            <div class="card-body">
                <form action="/save" method="POST">
                    @csrf
                    <div class="form-group">
                        <label>NIK</label>
                        <input type="number" name="nik_user" placeholder="Masukkan NIK" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="nama_user" placeholder="Masukkan Nama" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>No HP</label>
